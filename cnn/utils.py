...
def efficientnet_params(model_name):
    params_dict = {'efficientnet-b5': (1.6, 2.2, 456, 0.0),}
...
url_map = {'efficientnet-b5': 'https://github.com/lukemelas/EfficientNet-PyTorch/releases/download/1.0/efficientnet-b5-b6417697.pth'}
